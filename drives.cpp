...
void Get_Disk_Parameters_A()
{
   ...
   int32_t Head_Per_Cylinder = (Floppy[0x1B] << 8) + Floppy[0x1A];
   int32_t Sector_Per_Track = (Floppy[0x19] << 8) + Floppy[0x18];
   int32_t Number_Of_Sectors = (Floppy[0x14] << 8) + Floppy[0x13];

   int32_t Number_Of_Cylinders = Number_Of_Sectors / Sector_Per_Track / Head_Per_Cylinder;
...
void Get_Disk_Parameters_C()
{
   ...
   int32_t Head_Per_Cylinder = (drive[0x1B] << 8) + drive[0x1A];
   int32_t Sector_Per_Track = (drive[0x19] << 8) + drive[0x18];
   int32_t Number_Of_Sectors = (drive[0x14] << 8) + drive[0x13];
   ...
   int32_t Small_Sectors = (drive[0x14] << 8) + drive[0x13];
...
void Int13()
{
   ...
   if(Int13_Command != 0xFF)
   {
      ...
      {
         int32_t Cylinder = (int13_data[3] << 8) + int13_data[2];
         int32_t Sector = int13_data[4];
         int32_t Head = int13_data[5];
         int32_t Bytes_Per_Sector = (int13_data[0x0F] << 8) + int13_data[0x0E];
         int32_t Sector_Per_Track = (int13_data[0x10] & 0X3F) ;
         int32_t Head_Per_Cylinder = (int13_data[0x0D] << 8) + int13_data[0x0C];
         int32_t Number_Of_Sectors = int13_data[1];
         int32_t LBA = (Cylinder * Head_Per_Cylinder + Head) * Sector_Per_Track + (Sector - 1);
         int32_t Buffer_Address = (int13_data[10] << 12) + (int13_data[9] << 4) + (int13_data[8] << 8) + int13_data[7];
